...
RUN poetry run protol --create-package --in-place --python-out ./src/generated protoc --proto-path=../shared/proto ../shared/proto/event_service/*.proto ../shared/proto/user/*.proto ../shared/proto/interval/*.proto
